    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold">토큰 정보</h3>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="p-3 text-right">매수 평균가</th>
                <th className="p-3 text-right">투자 금액</th>
            ...
            <tbody>
              {mockTokenHoldings.map((token) => (
                <tr key={token.id} className="border-b">
                  ...
                  <td className="p-3 text-right">{token.investmentAmount.toLocaleString()}</td>
                  <td className="p-3 text-right">{token.currentValue.toLocaleString()}</td>
                  <td className="p-3 text-right">{token.dividendRate}%</td>
                </tr>
              ))}
            </tbody>
          </table>
